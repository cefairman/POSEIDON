                    ...
                    for i in range(N_b):
                        ...
                        for l in range(i_bot, N_layers):
                            ...
                            # For other cases, we always subtract two terms to compute traversed distance
                                ...
                                if np.isnan(dr[l, j_sector_back_in, k_in]):
                                    Path[i, j, k, l] = 0.0
                                else:
                                    Path[i, j, k, l] = symmetry_factor * (s1 + s2 - s3 - s4) / dr[
                                        l, j_sector_back_in, k_in]
...
def TRIDENT_gcm(P, r, r_up, r_low, dr, wl, kappa_clear, kappa_cloud,
    ...
    # of b and db.
    # removed need for it to be dayside sectory or top array as the max radial extent will be these things anyway
